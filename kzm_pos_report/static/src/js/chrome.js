odoo.define('kzm_pos_report.chrome', function (require) {
"use strict";
    console.log("===========")
    ...
    var SliderWidget = PosBaseWidget.extend({
        ...
        init: function(parent, options){
            ...
            self.x_report = function(){
                ...
                self.pos.chrome.do_action('kzm_pos_report.pos_x_report',{additional_context:{
                ...
                if(self.pos.config.iface_print_via_proxy){
                    var pos_session_id = self.pos.pos_session.id;
                    var report_name = "kzm_pos_report.pos_x_thermal_report_template";
                    var params = {
